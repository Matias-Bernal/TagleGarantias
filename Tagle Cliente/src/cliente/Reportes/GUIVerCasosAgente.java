...
public class GUIVerCasosAgente extends JFrame {
	...
	public GUIVerCasosAgente(MediadorReportes mediador, Vector<Pedido_PiezaDTO> pedidos_piezas, String titulo, Date FDesde, Date FHasta, String nombre_agente ) {
		this.setMediador(mediador);
		this.pedidos_piezas = pedidos_piezas;
		if(nombre_agente!="")
			this.titulo = titulo+ "AGENTE: "+nombre_agente;
		else
			this.titulo = titulo;
		this.FDesde = FDesde;
		this.FHasta = FHasta;
	...
	private void initialize() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(GUIVerCasosAgente.class.getResource("/cliente/Resources/Icons/1find.png")));
		...
		btnVolver.setIcon(new ImageIcon(GUIVerCasosAgente.class.getResource("/cliente/Resources/Icons/back.png")));
		...
		btnImprimir.setIcon(new ImageIcon(GUIVerCasosAgente.class.getResource("/cliente/Resources/Icons/printer.png")));
		...
		btnExportar.setIcon(new ImageIcon(GUIVerCasosAgente.class.getResource("/cliente/Resources/Icons/formulario.png")));
		...
		btnActualizar.setIcon(new ImageIcon(GUIVerCasosAgente.class.getResource("/cliente/Resources/Icons/1refresh.png")));
	...
	private void cargarDatos() {
		...
		anchos.add(mediano);
		nombreColumnas.add("Fecha Recepcion Agente");//14
		anchos.add(mediano);
