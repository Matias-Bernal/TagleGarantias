...
public class GUIVerReclamante extends JFrame{
	...
	public GUIVerReclamante(final MediadorPedido medidador, String nombre_reclamante, String email, String dni, Vector<String> telefonos) {
	 ...
	 */
	public GUIVerReclamante(final MediadorPedido medidador) {
		this.setMedidador(medidador);
	...
	private void initialize() {
		...
		btnVolver.setBounds(142, 167, 120, 20);
